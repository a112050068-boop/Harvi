...
const About: React.FC = () => {
  ...
  const fileId = "1Gykv-L_hkAf2GRdwvNKjIRSAw6Od0XVd";
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center pt-24 md:pt-32 pb-40 md:pb-60 px-5 md:px-12 overflow-x-hidden">
      ...
      <section className="w-full flex flex-col items-center relative">
        ...
        {/* 中心個人縮圖 (Instagram 連結) */}
        <div className="relative group z-10 mb-20 md:mb-48">
          <a 
            href={instagramUrl}
            target="_blank" 
            rel="noopener noreferrer"
            className="block relative w-40 md:w-64 aspect-square md:aspect-[4/3] bg-[#050505] overflow-hidden rounded-sm border border-white/10 transition-all duration-700 hover:border-blue-500/50 hover:scale-110 shadow-[0_0_80px_rgba(0,0,0,0.9)]"
          >
            <img 
              src={avatarUrl} 
              alt="哈維 HARVI" 
              ...
              onError={(e) => {
                (e.currentTarget as HTMLImageElement).src = "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=800&auto=format&fit=crop";
              }}
            />
            
            <div className="absolute top-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <svg className="w-5 h-5 md:w-6 md:h-6 text-white drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute top-0 left-0 w-full h-[2px] bg-blue-500 shadow-[0_0_20px_#0066FF] opacity-0 group-hover:opacity-100 pointer-events-none z-10"
          ...
          <div className="absolute -bottom-8 md:bottom-10 left-1/2 -translate-x-1/2 text-[8px] md:text-[9px] font-mono tracking-[0.3em] md:tracking-[0.4em] text-white/20 uppercase whitespace-nowrap group-hover:text-blue-500 transition-colors">
            Contact_via_Instagram
          </div>
        </div>
